...
{
	int num1, num2, proc_num, proc_rank, comp_result, i = 0;
	...
	MPI_Gather( &comp_result, 1, MPI_INT, buf_result, 10, MPI_INT, 0, MPI_COMM_WORLD );	// рез-т сравнения на 0 процессе
