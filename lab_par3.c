...
int main(int argc, char **argv)
{
	...
	MPI_Gather( a+proc_rank*sizeof(double)*(i2-i1)*JSIZE, (i2-i1)*JSIZE, MPI_DOUBLE, result, (i2-i1)*JSIZE, MPI_DOUBLE, 0, MPI_COMM_WORLD );
	// указательная арифметика!! - разобраться! сдвиг по даблам или по ячейкам? Сегм. ошибка!!
